...
public class Login extends CommandDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblNewLabel.setBounds(60, 83, 58, 20);
		...
		txt_id.setBounds(124, 79, 271, 26);

		this.txt_id.setFocus();

		Label lblNewLabel_1 = new Label(composite, SWT.NONE);
		lblNewLabel_1.setAlignment(SWT.RIGHT);
		lblNewLabel_1.setBounds(48, 118, 71, 20);
		...
		txt_pw.setBounds(124, 114, 271, 26);

		ck_autoLogin = new Button(composite, SWT.CHECK);
		ck_autoLogin.setBounds(200, 156, 119, 16);
