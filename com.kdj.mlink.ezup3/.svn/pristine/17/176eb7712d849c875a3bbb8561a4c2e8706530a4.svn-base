...
public class ShopProductDto {
	...
	private String marginseq;

	private String ebaycatcd;
	private String shopcatcd;
	private String shopgeneral;

	private String islimit; // 소비자 준수가격
	private String limit_price; // 가격준수가..
	private String delivery_qty; // 묶음 배송수량.

	private String select_option; // 옵션
	private String text_option; // 옵션
	private String shop_cid_info; // 옵션
	...
	public String getShop_cid_info() {
		return shop_cid_info;
	}

	public void setShop_cid_info(String shop_cid_info) {
		this.shop_cid_info = shop_cid_info;
	}
	...
	public String getEbaycatcd() {
		return ebaycatcd;
	}

	public void setEbaycatcd(String ebaycatcd) {
		this.ebaycatcd = ebaycatcd;
	}

	public String getShopcatcd() {
		return shopcatcd;
	}

	public void setShopcatcd(String shopcatcd) {
		this.shopcatcd = shopcatcd;
	}

	public String getShopgeneral() {
		return shopgeneral;
	}

	public void setShopgeneral(String shopgeneral) {
		this.shopgeneral = shopgeneral;
	}

	public String getMarginseq() {
		return marginseq;
	}

	public void setMarginseq(String marginseq) {
		this.marginseq = marginseq;
	}
	...
	public void setUseYn(String soldout) {
		this.useYn = soldout;
	}

	List<ShopProdAttrnmDto> shopProdAttrnmDto; // 상품고시..
	ShopCatInfDto shopCatIn;// 카테고리..

	// --- 도매의신. 카테고리 맵핑
	List<MapperShopCateDto> mapperShopCateDtos;
	// --- 도매의신. 옵션 맵핑
	List<DomesinOption> domesinOptions;

	public List<DomesinOption> getDomesinOptions() {
		return domesinOptions;
	}

	public void setDomesinOptions(List<DomesinOption> domesinOptions) {
		this.domesinOptions = domesinOptions;
	}

	public List<MapperShopCateDto> getMapperShopCateDtos() {
		return mapperShopCateDtos;
	}

	public void setMapperShopCateDtos(List<MapperShopCateDto> mapperShopCateDtos) {
		this.mapperShopCateDtos = mapperShopCateDtos;
	}

	private String result_code; // 정상

	public List<ShopProdAttrnmDto> getShopProdAttrnmDto() {
		return shopProdAttrnmDto;
	}

	public void setShopProdAttrnmDto(List<ShopProdAttrnmDto> shopProdAttrnmDto) {
		this.shopProdAttrnmDto = shopProdAttrnmDto;
	}
	...
	private String class_nm1;// 대분류코드
	private String class_nm2;// 중분류코드
	private String class_nm3;// 소분류코드
	private String class_nm4;// 세분류코드
	...
	private String errinsertdt;// 입력일자
	private String errinsertid;// 입력자아이디
	...
	private String shopcatno;// 카테고리코드
	...
	private String updateFlag;// 카페24때문에 구분지을려고 추가

	public String getErrinsertdt() {
		return errinsertdt;
	}

	public void setErrinsertdt(String errinsertdt) {
		this.errinsertdt = errinsertdt;
	}

	public String getErrinsertid() {
		return errinsertid;
	}

	public void setErrinsertid(String errinsertid) {
		this.errinsertid = errinsertid;
	}
	...
	public String getShopcatno() {
		return shopcatno;
	}

	public void setShopcatno(String shopcatno) {
		this.shopcatno = shopcatno;
	}
	...
	public ShopCatInfDto getShopCatInDto() {
		return shopCatIn;
	}

	public void setShopCatInDto(ShopCatInfDto shopCatIn) {
		this.shopCatIn = shopCatIn;
	}

	public String getClass_nm1() {
		return class_nm1;
	}

	public void setClass_nm1(String class_nm1) {
		this.class_nm1 = class_nm1;
	}

	public String getClass_nm2() {
		return class_nm2;
	}

	public void setClass_nm2(String class_nm2) {
		this.class_nm2 = class_nm2;
	}

	public String getClass_nm3() {
		return class_nm3;
	}

	public void setClass_nm3(String class_nm3) {
		this.class_nm3 = class_nm3;
	}

	public String getClass_nm4() {
		return class_nm4;
	}

	public void setClass_nm4(String class_nm4) {
		this.class_nm4 = class_nm4;
	}

	public String getGoods_gubun_nm() {
		return goods_gubun_nm;
	}

	public void setGoods_gubun_nm(String goods_gubun_nm) {
		this.goods_gubun_nm = goods_gubun_nm;
	}
	...
	public void setDelv_type_nm(String delv_type_nm) {
		this.delv_type_nm = delv_type_nm;
	}
