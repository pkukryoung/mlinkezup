...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		openViewAction = new OpenViewAction(window, "Open Another Message IntroView", View.ID);
//		openViewAction = new OpenViewAction(window, "Open Another Message IntroView", ProductManager.ID);
