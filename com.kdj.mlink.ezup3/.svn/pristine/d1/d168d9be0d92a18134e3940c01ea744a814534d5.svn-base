...
public class ShopWorkDto {
	private String rowno;//순번을위한것
	private String workseq;//작업관리일련번호
	private String shopcd;//쇼핑몰코드
	private String compno;//회사코드
	private String workcd;//작업코드
	private String workdetcd;//작업상세코드
	private String insertid;//작업자
	private String workdatefrom;//작업시작시간
	private String workdateto;//작업종료시간
	private String workdlapsed;//경과시간
	private String workstats;//상태
	private String workcurrrate;//진행률
	private String workmessage;//메세지
	private String worklog;//상세로고
	...
	private String goods_cost;//자체 상품 원가
	...
	private String shopprodno;//완료후쇼핑몰코드(등록수정을한폼으로진행하기위해)
	private String shopseq;//SHOPDTL일련번호
	private String user_id;//
	private String password;//
	private String nicknm2;//닉네임명
	private String nicknm1;//닉네임
	private String authkey1;//인증키1
	private String authkey2;//인증키2
	private String orderexcel1;//
	private String orderexcel2;//
	private String orderexcel3;//
	private String apikey;//
	private String dealtread;//
	private String shopcompar;//가격비교수수료율
	private String addrseq;//부가정보코드
	...
	public String getWorkdetcd() {
		return workdetcd;
	}
	public void setWorkdetcd(String workdetcd) {
		this.workdetcd = workdetcd;
	}
	...
	public String getWorkdlapsed() {
		return workdlapsed;
	}
	public void setWorkdlapsed(String workdlapsed) {
		this.workdlapsed = workdlapsed;
	}
	...
	public String getWorkcurrrate() {
		return workcurrrate;
	}
	public void setWorkcurrrate(String workcurrrate) {
		this.workcurrrate = workcurrrate;
	}
	...
	public String getNicknm2() {
		return nicknm2;
	}
	public void setNicknm2(String nicknm2) {
		this.nicknm2 = nicknm2;
	}
	public String getNicknm1() {
		return nicknm1;
	}
	public void setNicknm1(String nicknm1) {
		this.nicknm1 = nicknm1;
	}
	...
	public String getOrderexcel1() {
		return orderexcel1;
	}
	public void setOrderexcel1(String orderexcel1) {
		this.orderexcel1 = orderexcel1;
	}
	public String getOrderexcel2() {
		return orderexcel2;
	}
	public void setOrderexcel2(String orderexcel2) {
		this.orderexcel2 = orderexcel2;
	}
	public String getOrderexcel3() {
		return orderexcel3;
	}
	public void setOrderexcel3(String orderexcel3) {
		this.orderexcel3 = orderexcel3;
	}
	...
	public String getDealtread() {
		return dealtread;
	}
	public void setDealtread(String dealtread) {
		this.dealtread = dealtread;
	}
	public String getShopcompar() {
		return shopcompar;
	}
	public void setShopcompar(String shopcompar) {
		this.shopcompar = shopcompar;
	}
